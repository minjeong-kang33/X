...
<form name="ckDelete" action="adSellDelete.jsp" method="post">
<table border="1">
...
if(currentPage>1) {
	%>
	<a href="adSellList.jsp?pageNum=<%=currentPage-1 %>">[1페이지 이전]</a>
	<%
}
...
if(currentPage<pageCount) {
	%>
	<a href="adSellList.jsp?pageNum=<%=currentPage+1 %>">[1페이지 다음]</a>
	<%
}
