...
<div class="container">
	...
	<form action="adUserReportListPro.jsp" method="post">
		...
		<div>
		총 멤버 <%=dao.adUserReportCount() %>명
		</div>
<form name="ckDelete" action="adUserReportDelete.jsp" method="post">
<table border="1">
...
%>
<a href="adUserReportList.jsp?pageNum=<%=startPage-pageBlock%>">[10페이지 이전]</a>
<%
}
%>
<a href="adUserReportList.jsp?pageNum=<%=i %>"><%=i %></a>
<%
}
if(endPage < pageCount){
%>
<a href="adUserReportList.jsp?pageNum=<%=startPage+pageBlock%>">[10페이지 다음]</a>
<%
}
%>
<div>
